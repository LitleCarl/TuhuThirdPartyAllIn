...
+ (UIImage*)renderDataMatrix:(DataMatrix*)matrix imageDimension:(int)imageDimension color:(uint32_t)color{
    ...
    int matrixDimension = (int)[matrix dimension];
    ...
    const uint32_t white = 0xFFFFFFFF, transp = 0x00FFFFFF;
    
    
    uint32_t black = color;
